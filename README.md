...
- Filters cover role, experience type, level, and modality. Module modalities are derived at build time from page directives; playlist and course modalities are derived from their modules.
