...
description: Explore speech recognition
---
...
> **NOTE**: Why sampling rate matters:
>
...
> **NOTE**: Phonemes are language-specific. A model trained on English phonemes can't recognize Mandarin tones without retraining.
...
> **CAUTION**: Decoding is computationally intensive. Real-time applications balance accuracy and latency by limiting beam width and hypothesis depth.
