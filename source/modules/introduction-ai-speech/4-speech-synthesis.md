...
description: Explore speech synthesis
---
...
> **TIP**: Different domains require specialized normalization rules. Medical text handles drug names and dosages differently than financial text handles currency and percentages.
...
> **IMPORTANT**: Prosody dramatically affects naturalness. Robotic-sounding speech often results from flat, monotone prosody—not from imperfect phoneme pronunciation.
...
> **NOTE**: What makes neural vocoders effective:
>
