...
description: Visualize real-time data
---
...
> **TIP**: To learn more about Real-Time Dashboards, see **[Create a Real-Time Dashboard](/fabric/real-time-intelligence/dashboard-real-time-create?azure-portal=true)**.
...
> **TIP**: To learn more about using Power BI with real-time data in Fabric, see **[Visualize data in a Power BI report](/fabric/real-time-intelligence/create-powerbi-report?azure-portal=true)**.
