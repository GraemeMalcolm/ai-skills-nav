---
title: Store and query real-time data
description: Store and query real-time data
---
...
> **TIP**: To learn more about KQL, see **[Kusto Query Language (KQL) overview](/kusto/query/?azure-portal=true)**.
...
> **TIP**: For more information about working with KQL databases, including detailed examples of update policies, materialized views, and stored functions, see **[Work with real-time data in a Microsoft Fabric Eventhouse](/training/modules/query-data-kql-database-microsoft-fabric/?azure-portal=true)**.
...
> **TIP**: To learn more about Copilot for Real-Time Intelligence, see **[Copilot for Real-Time Intelligence](/fabric/real-time-intelligence/copilot-writing-queries?azure-portal=true)**.
