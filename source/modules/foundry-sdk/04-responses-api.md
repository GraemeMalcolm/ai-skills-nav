...
> **NOTE**: The *Responses* API is the recommended approach for generating AI responses in Microsoft Foundry applications. It replaces the older *ChatCompletions* API for most scenarios.
