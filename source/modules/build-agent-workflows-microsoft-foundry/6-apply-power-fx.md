...
description: Learn how to apply Power Fx expressions in workflows in Microsoft Foundry.
---
...
> **TIP**: For more information about the Power Fx language, visit the [Power Fx documentation](/power-platform/power-fx/overview?azure-portal=true).
