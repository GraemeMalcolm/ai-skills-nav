...
description: Learn how to add and configure agents in a workflow in Microsoft Foundry.
---
...
![Screenshot of the Invoke agent node parameters showing the response schema configuration.](media/agent-parameters.png)
...
![Screenshot showing how to store agent output in a variable for later use in the workflow.](media/agent-action-settings.png)
