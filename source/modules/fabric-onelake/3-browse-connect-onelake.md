...
description: >-
  Use the OneLake catalog to find data across workspaces, evaluate endorsement and metadata, and connect with shortcuts
  or semantic models.
---
...
![Diagram of three connection options from discovered data: connect directly, internal shortcut, or external shortcut.](media/discovery-connection-flow.png)

> **TIP**: Think about your organization. How do you know if your data sources are trustworthy? How do you connect to data and build with it?
