...
description: >-
  Explore how OneLake provides one storage layer for all Fabric data in open formats and makes it discoverable across
  your tenant.
---
...
![Diagram of OneLake architecture showing a tenant with workspaces containing items over open Delta and Parquet formats.](media/onelake-architecture.png)
...
> **TIP**: Which data source paths are most valuable in your organization to limit or eliminate data duplication?
