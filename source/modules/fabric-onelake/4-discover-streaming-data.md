---
title: Discover streaming data in Real-Time hub
description: >-
  Discover streaming data in Real-Time hub, understand eventstreams and eventhouses, and decide how to use discovered
  streams.
---
...
![Diagram of OneLake catalog for stored data alongside Real-Time hub for streaming data feeding one solution.](media/batch-streaming-discovery.png)

> **TIP**: Does your organization use streaming data? Do you also track streaming data in a warehouse or lakehouse?
