...
![Diagram showing Hospital, Department, Room, and Patient entities connected by labeled relationships in Fabric IQ.](media/ontology-modeling.png)
...
![Screenshot of VitalSign entity type showing properties including HeartRate, OxygenSaturation, RespiratoryRate, and Timestamp in Fabric IQ ontology editor.](media/vital-sign-properties.png)
...
![Screenshot showing data binding configuration with timeseries properties mapped from eventhouse source columns to entity type properties in Fabric IQ.](media/data-binding.png)
