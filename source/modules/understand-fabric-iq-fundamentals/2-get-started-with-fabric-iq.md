...
description: Explore how Fabric IQ defines ontology items and binds business concepts to OneLake data.
---
...
![Screenshot showing the New item dialog with Ontology option selected.](media/new-ontology-item.png)
...
![Screenshot showing the ontology configuration canvas with entity types, properties, and relationships.](media/configuration-canvas.png)
...
![Screenshot showing the ontology preview experience with graph visualization and entity instances.](media/preview-ontology.png)
