---
title: Transform data with T-SQL queries
description: Use T-SQL queries to filter, join, aggregate, and reshape data in a Microsoft Fabric warehouse.
---
...
> **TIP**: The Visual Query Editor is a good option for quick data exploration or when building simple joins. For complex transformations that involve window functions, CTEs, or conditional logic, use the SQL query editor.
