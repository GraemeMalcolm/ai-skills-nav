---
title: Create views for reusable logic
description: Create views in a Microsoft Fabric warehouse to create reusable transformation logic.
---
...
> **NOTE**: Fabric warehouses support custom schemas. Organize views into schemas like `gold` or `reporting` to separate them from staging and intermediate objects.
