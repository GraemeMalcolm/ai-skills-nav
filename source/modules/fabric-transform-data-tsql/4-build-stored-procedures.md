---
title: Build stored procedures
description: Build stored procedures for repeatable and parameterized data processing in a Microsoft Fabric warehouse.
---
...
> **TIP**: Use a naming convention like `usp_` (user stored procedure) to distinguish your custom procedures from system procedures. This process makes it easier to identify and manage your transformation logic in the Explorer pane.
...
> **NOTE**: A later module on data pipelines covers pipeline orchestration of stored procedures in more detail.
