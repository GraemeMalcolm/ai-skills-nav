---
title: Implement dimensional tables
description: Implement fact and dimension tables in a Microsoft Fabric warehouse using T-SQL.
---
...
> **NOTE**: Organize your dimensional tables using schemas that reflect their role. Common conventions include `dim` for dimension tables, `fact` for fact tables, and `staging` for raw source data.
