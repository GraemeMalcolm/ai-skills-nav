...
> **CAUTION**: Key-based authentication is convenient for testing and development, but Microsoft Entra ID authentication is recommended for production scenarios. You should treat API keys like any sensitive credential; storing them securely and avoiding hard-coding them in client code.
