...
![Screenshot of the Sora model in the Foundry Playground with parameters and a prompt.](media/video-prompt-playground.png)
...
![Screenshot of the Sora model in the Foundry Playground with sample code.](media/video-code-sample-playground.png)
...
> **NOTE**: **Bash** is a command line shell and scripting language. Curl is a command that you run inside Bash. 
