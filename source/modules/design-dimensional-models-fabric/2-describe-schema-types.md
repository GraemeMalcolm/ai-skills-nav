---
title: Describe dimensional schema types
description: Learn about star and snowflake schema types for analytics workloads
---
...
![Diagram that shows a star schema with a central Fact_Sales table connected to four dimension tables: Dim_Product, Dim_Customer, Dim_Date, and Dim_Store.](media/star-schema.svg)
...
> **TIP**: Start with a star schema for most projects. Its simplicity and performance benefits outweigh the minor storage costs of denormalized dimension tables.
...
![Diagram that shows a snowflake schema with a central fact table and normalized dimension tables branching outward into subcategory, category, and geography.](media/snowflake-schema.svg)
