...
![Screenshot of text-to-speech in the Foundry playground.](media/text-to-speech-playground.png)
...
![Screenshot of text-to-speech Python code.](media/text-to-speech-python.png)
