...
> **NOTE**: An *API* (Application Programming Interface) is a set of rules and endpoints that allows one software application to communicate with and use the functionality or data of another application.
...
![Screenshot of speech-to-text in the Foundry playground.](media/speech-to-text-playground.png)
...
> **NOTE**: A client library is a set of ready‑made code that developers can use in their application to easily talk to a service or API. 
...
> **NOTE**: Application code is written in *code editors*, such as Visual Studio Code. A code editor’s *terminal* is a built‑in command‑line window inside the editor where you can run commands without leaving your development environment.  
...
![Screenshot of speech-to-text python code in Visual Studio Code.](media/speech-to-text-python.png)
