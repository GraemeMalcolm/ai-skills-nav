...
![Screenshot of a voice-enabled agent.](media/speech-session.png)
...
> **NOTE**: You also need to install `pyaudio`, `python-dotenv`, and `azure-identity` in order to run your Voice Live application.
...
![Screenshot of voice live in the Foundry playground sample code.](media/voice-live-playground-code.png)
