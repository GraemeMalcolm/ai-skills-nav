...
![Screenshot showing the Add relationship type dialog showing the name field and source and target entity type dropdowns.](media/add-relationship-type.png)
...
![Screenshot of Relationship configuration with departments table and HospitalId and DepartmentId mapped to entity keys.](media/relationship-configuration.png)
