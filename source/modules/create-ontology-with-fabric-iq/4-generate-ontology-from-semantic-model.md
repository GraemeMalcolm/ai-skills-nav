...
![Screenshot of the Generate Ontology button in the Power BI semantic model ribbon in Fabric.](media/generate-ontology-button.png)
...
![Screenshot of the ontology editor showing the Entity Types pane on the left listing hospitals, departments, rooms, patients, and vitalsignequipment.](media/ontology-editor.png)
