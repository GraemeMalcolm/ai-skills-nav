...
![Screenshot of Room entity overview with relationship graph, property charts, and entity instances table.](media/preview-experience.png)

> **NOTE**: When you first open the preview experience, you'll see an **"Updating your ontology"** message while the system processes your data in the background. After 1-2 minutes, refresh your browser to display the entity type overview.
