...
description: >-
  Learn how to configure agent instructions to control retrieval behavior, test different query types, and ensure
  consistent citation and grounding in production.
---
