---
title: Understand data warehouses in Fabric
description: Understand data warehouses in Fabric
---
...
> **TIP**: For more information, see the [Clone table in Microsoft Fabric](/fabric/data-warehouse/clone-table) documentation.
