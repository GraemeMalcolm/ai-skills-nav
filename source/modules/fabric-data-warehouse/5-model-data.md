---
title: Model data in a warehouse
description: Model data in a warehouse
---
...
> **NOTE**: Most data warehouses use dimensional modeling. Relationships can be created to shape a **star schema**, which is an ideal model for analytics. For more information, see the [Design dimensional models in Microsoft Fabric](/training/modules/design-dimensional-models-fabric) module.
...
> **TIP**: Semantic model design and scalability patterns are covered in greater depth in [Design scalable semantic models](/training/modules/design-power-bi-application-lifecycle-management-strategy/). This unit focuses on modeling data in the warehouse itself.
