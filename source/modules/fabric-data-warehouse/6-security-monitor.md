---
title: Secure and monitor a warehouse
description: Secure and monitor a warehouse
---
...
> **TIP**: For more information, see [Workspaces in Power BI](/power-bi/collaborate-share/service-new-workspaces#roles-and-licenses).
### Item permissions
...
> **TIP**: Row-level security, column-level security, and dynamic data masking are covered in depth in [Secure a Microsoft Fabric data warehouse](/training/modules/secure-data-warehouse-in-microsoft-fabric/).
