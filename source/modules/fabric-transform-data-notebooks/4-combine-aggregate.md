---
title: Combine and aggregate data
description: Combine and aggregate data from multiple sources using Spark SQL and PySpark.
---
...
> **TIP**: When building complex transformations, start simple and build up. Test each step in a separate cell before combining them into a complete pipeline.
