---
title: Shape and clean data
description: Shape and clean data using Spark SQL and PySpark in notebooks.
---
...
> **NOTE**: Spark SQL and PySpark support the same underlying data types. You can mix both languages in the same notebook using the `%%sql` magic command. Choose whichever syntax feels more natural for each task.
