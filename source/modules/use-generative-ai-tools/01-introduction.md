...
> **NOTE**: The use of *tools* in generative AI model prompts shouldn't be confused with *[Foundry Tools](/azure/ai-services/reference/sdk-package-resources?azure-portal=true)*; which are Azure AI APIs that you can use in your applications and agents.
...
> **TIP**: You can learn more about how to use the Microsoft Foundry Agents SDK to create agents with persisted configurations in [Develop AI agents on Azure](/training/paths/develop-ai-agents-azure/).
