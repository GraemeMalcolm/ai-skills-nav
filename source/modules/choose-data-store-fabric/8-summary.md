...
title: Summary
description: >-
  Review key concepts for choosing analytical data stores in Microsoft Fabric, including when to use lakehouse,
  warehouse, and eventhouse for different business scenarios.
---
