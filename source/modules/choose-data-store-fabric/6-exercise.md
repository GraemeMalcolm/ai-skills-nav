...
description: >-
  Explore how lakehouse, warehouse, eventhouse, and other data stores work together in a complete Fabric architecture
  through a real-world retail scenario.
---
...
> **NOTE**: For each workload, read the scenario first and form your own recommendation. Then select the **Recommendation** tab to check your answer.
...
![Diagram showing Contoso's four analytical workloads: data engineering, business intelligence, real-time monitoring, and machine learning.](media/contoso-overview.svg)
...
![Architecture showing data sources flowing into lakehouse with raw files zone, Spark notebook transformations, and curated Delta tables.](media/lakehouse-data-engineering.svg)
...
![Diagram showing warehouse star schema with fact and dimension tables, connected to Power BI through Direct Lake.](media/warehouse-star-schema.svg)
...
![Diagram showing point-of-sale systems streaming inventory events to eventhouse with real-time dashboard powered by KQL queries.](media/eventhouse-streaming.svg)
...
![Complete architecture showing lakehouse, warehouse, eventhouse, and ML lakehouse integrated through OneLake.](media/contoso-complete-architecture.svg)
