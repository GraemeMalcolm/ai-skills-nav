...
> **NOTE**: If your organization isn't using Fabric or Power BI today, you can sign up for a [free Fabric trial](/fabric/get-started/fabric-trial) to explore its features.
...
> **NOTE**: Learn more about workspaces in the [Fabric documentation](/fabric/get-started/workspaces).
...
![Screenshot of the OneLake catalog.](media/onelake-catalog.png)
...
> **NOTE**: Copilot in Microsoft Fabric is enabled by default. Administrators can disable Copilot from the **Admin portal > Tenant settings** or control access for specific security groups or at the capacity level.
