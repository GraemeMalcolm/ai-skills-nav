...
![Diagram of Fabric compute engines such as Data Engineering, Data Warehouse, Data Factory, Power BI, and Real-Time Intelligence all accessing the same OneLake data storage.](media/onelake-architecture.png)
...
> **NOTE**: Review the [Microsoft Fabric administration](/fabric/admin) documentation for more information.
