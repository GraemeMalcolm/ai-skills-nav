...
![Screenshot of the new Foundry portal with audio analyzed with Azure Content Understanding.](media/audio-extraction-playground.png)
...
![Screenshot of the new Foundry portal where audio is analyzed and JSON is returned.](media/audio-json-result.png)
